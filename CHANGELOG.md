...
- Raw keyboard polling now delegates command selection to a testable `CommandDispatcher`, preserving all existing timer shortcuts while allowing routing tests without a real terminal.
